...
## Exposure Alignment
Treatment is the first FCE on-site CAA inspection. Treated population: TRI-reporting manufacturing facilities matched to ICIS-Air via FRS. Outcome measured at the same facility, ensuring direct exposure alignment. Identifying variation: air vs non-air media within the same facility-chemical cell, before vs after first inspection.
