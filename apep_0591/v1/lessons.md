...
- **Process:** 4 rounds of advisor review were needed because early rounds missed issues that later rounds caught (nested table labels, employment discussion inconsistency, sample size mismatch). Running a thorough self-audit before advisor review would save time.
